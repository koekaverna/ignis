...
| A3 | **RUNNING (C22)** — soak in progress on this box; the pgsql leg cannot run here (no PostgreSQL server).  | V-10 is 1 thread and predates E6/E13/E14/E16 | RSS within ±2% between 1M and 10M; 0 errors; watchdog silent |
