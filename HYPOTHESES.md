...
| H-INT-6 | A live stuck worker is abandoned (ZTS) or killed (NTS) within `stall_abandon_ms`, its in-flight requests get 504, a replacement serves within 1 s; a child killed holding the opcache lock does not poison the next | S-10, S-16 | 2.5 s / 0.5 s / 1 s; opcache no restart pending | 90 min | CONFIRMED (V-124 S-10: abandoned at 3 029 ms, replacement served, leaked_workers=1) |
